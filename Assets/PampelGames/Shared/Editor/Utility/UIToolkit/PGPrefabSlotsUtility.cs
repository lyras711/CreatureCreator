...
namespace PampelGames.Shared.Editor
{
    ...
    public static class PGPrefabSlotsUtility
    {
        ...
        public static VisualElement CreateDragDropSlot()
        {
            ...
            dragDropSlot.style.backgroundColor = PGColorsUtility.InputFieldBackground();
            dragDropSlot.PGBorderColor(PGColorsUtility.InspectorBorder());
            ...
            dragDropLabel.style.color = PGColorsUtility.ReadOnlyText();
