...
namespace PampelGames.Shared.Utility
{
    public static class PGListViewExtensions
    {
        ...
        public static void PGStandardListViewStyle(this ListView listView)
        {
            ...
            listView.style.backgroundColor = PGColorsUtility.InspectorBackground();
        }
        ...
        public static void PGButtonsRedGreenHover(this ListView listView, StyleColor originalColor = default)
        {
            ...
            removeButton.RegisterCallback<MouseEnterEvent>((evt) => removeButton.style.backgroundColor = PGColorsUtility.HoverButtonRed());
            ...
            addButton.RegisterCallback<MouseEnterEvent>((evt) => addButton.style.backgroundColor = PGColorsUtility.HoverButtonGreen());
